...
class ChatApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
        ...
        home: chatPage(),
        routes: {
           '/chatpage':(context) => chatPage()   //this is anohter way that we called it named routes means we named a route with a key value which treated as his name and can be used   
